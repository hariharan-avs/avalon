...
def test_wo_req_sig_wrg(json_metadata):
    r = exc_test('python test_wo_req_sig_wrg.py --input_dir ./wo_req_sig_wrg/ --connect_uri "http://localhost:1947" wo_req_sig_wrg')
    json_metadata['script'] = "test_wo_req_sig_wrg.py"
    json_metadata['input_dir']= "wo_req_sig_wrg"
    json_metadata['description']= "Work Order Request Payload sign with wrong payload format"
    json_metadata['additional_info']= "Expected result: 4 – invalid signature, Errors and status is returned code"
...
def test_wo_submit_empty_indata_and_outdata_parameter(json_metadata):
    r = exc_test('python test_wo_submit_empty_indata_and_outdata_parameter.py --input_dir ./wo_submit_empty_indata_and_outdata_parameter/ --connect_uri "http://localhost:1947" wo_submit_empty_indata_and_outdata_parameter')

    json_metadata['script'] = "test_wo_submit_empty_indata_and_outdata_parameter.py"
    json_metadata['input_dir']= "wo_submit_empty_indata_and_outdata_parameter"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"

    assert r.returncode == 0

def test_wo_submit_empty_String_datahash_index_indata(json_metadata):
    r = exc_test('python test_wo_submit_empty_String_datahash_index_indata.py --input_dir ./wo_submit_empty_String_datahash_index_indata/ --connect_uri "http://localhost:1947" wo_submit_empty_String_datahash_index_indata')

    json_metadata['script'] = "test_wo_submit_empty_String_datahash_index_indata.py"
    json_metadata['input_dir']= "wo_submit_empty_String_datahash_index_indata"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"

    assert r.returncode == 0

def test_wo_submit_no_outdata_parameter(json_metadata):
    r = exc_test('python test_wo_submit_no_outdata_parameter.py --input_dir ./wo_submit_no_outdata_parameter/ --connect_uri "http://localhost:1947" wo_submit_no_outdata_parameter')

    json_metadata['script'] = "test_wo_submit_no_outdata_parameter.py"
    json_metadata['input_dir']= "wo_submit_no_outdata_parameter"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"

    assert r.returncode == 0
    
def test_wo_submit_changing_order_index(json_metadata):
    r = exc_test('python test_wo_submit_changing_order_index.py --input_dir ./wo_submit_changing_order_index/ --connect_uri "http://localhost:1947" wo_submit_changing_order_index')

    json_metadata['script'] = "test_wo_submit_changing_order_index.py"
    json_metadata['input_dir']= "wo_submit_empty_String_datahash_index_indata"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"
...
def test_wo_sig_req_param_signingAlg(json_metadata):
    r = exc_test('python test_wo_sig_req_param_signingAlg.py --input_dir ./wo_sig_req_param_signingAlg/ --connect_uri "http://localhost:1947" wo_sig_req_param_signingAlg')

    json_metadata['script'] = "test_wo_sig_req_param_signingAlg.py"
    json_metadata['input_dir']= "wo_submit_empty_String_datahash_index_indata"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"
...
def test_wo_sig_req_hash_priv_sign_key(json_metadata):
    r = exc_test('python test_wo_sig_req_hash_priv_sign_key.py --input_dir ./wo_sig_req_hash_priv_sign_key/ --connect_uri "http://localhost:1947" wo_sig_req_hash_priv_sign_key')

    json_metadata['script'] = "test_wo_sig_req_hash_priv_sign_key.py"
    json_metadata['input_dir']= "wo_submit_empty_String_datahash_index_indata"
    json_metadata['description']= "Work Order submit with empty indata and outdata parameter"
    json_metadata['additional_info']= "Expected result: No outdata in response"
