        ...
        for file in sorted(files) :
            ...
            if "WorkOrderGetResult" in input_json_str1 and err_cd == 0:
                ...
                if "result" in response and "workOrderId" in response["result"].keys() and err_cd == 0:
                    if response["result"]["workerId"] == inp_worker_id and response["result"]["workOrderId"] == inp_worker_order_id and response["result"]["workloadId"] == inp_workload_id and response["result"]["requesterId"] == inp_requester_id:
