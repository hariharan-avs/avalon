    ...
    if input_json_dir:
        ...
        for file in sorted(files) :
            ...
            if "WorkOrderSubmit" in input_json_str1 and err_cd == 0:
                ...
                input_json_str1 = sig_obj.generate_client_signature(input_json_str1, worker_obj, encrypted_session_key, session_iv, private_key)
            ...
            if "WorkOrderGetResult" in input_json_str1 and err_cd == 0:
                ...
                if sig_bool > 0:
                    logger.info("ERROR: Signature Verified when failure Expected")
                    err_cd = 1
                else :
                    logger.info("SUCCESS: Signature Failed as Expected")
                    err_cd = 0
