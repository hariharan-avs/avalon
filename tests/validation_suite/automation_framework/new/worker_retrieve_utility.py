...
def process_worker_retrieve(input_json_str, tamper, output_json_file_name,
               uri_client, worker_obj, sig_obj, worker_id, request_id,
               check_lookup_result) :
    ...
    if input_json_str == {} :
        ...
        worker_lookup_obj.set_worker_id(worker_id)
