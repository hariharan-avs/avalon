...
def test_work_order_with_empty_data_and_datahash_in_indata(setup_config):
    ...
    input_json_file = './work_order/input/work_order_with_empty_data_and_datahash_in_indata.json'
    input_type = 'file'
    output_json_file_name = 'work_order_with_empty_data_and_datahash_in_indata'
    tamper = {"params": {}}
